    ...
    describe('Ether to Token', function () {
        describe('Exact input', function () {
            it('normal', async function () {
                ...
                expect(
                    await this.token.balanceOf.call(user1)
                ).to.be.bignumber.gt(
                    kyberswapAmount
                );
                expect(
                ...
                expect(
                    await balanceProxy.delta()
                ).to.be.bignumber.eq(ether('0'));
                expect(
                    await balanceUser1.delta()
                ).to.be.bignumber.eq(
                    ether('0').sub(
                        ether('1')
                    ).sub(
            ...
            it('min rate too high', async function () {
                ...
                expect(await this.token.balanceOf.call(this.proxy.address)).to.be.bignumber.eq(
                    ether('0')
                );
