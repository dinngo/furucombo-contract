const polygon = require('../../deploy/utils/addresses_polygon');
...
module.exports = {
  ...
  WRAPPED_NATIVE_TOKEN: polygon.WRAPPED_NATIVE_TOKEN,
  ...
  /* WMATIC */
  WMATIC_TOKEN: polygon.WRAPPED_NATIVE_TOKEN,
  ...
  /* STG */
  STG_TOKEN: polygon.STARGATE_TOKEN,
  ...
  AAVEPROTOCOL_V3_PROVIDER: polygon.AAVEPROTOCOL_V3_PROVIDER,
  ...
  CURVE_ATRICRYPTOCRV_PROVIDER: '0xb0a366b987d77b5ed5803cbd95c80bb6deab48c0',
  ...
  SUSHISWAP_DAI_WETH: '0x6FF62bfb8c12109E8000935A6De54daD83a4f39f',
  ...
  STARGATE_PARTNER_ID: polygon.STARGATE_PARTNER_ID,
  STARGATE_ROUTER: polygon.STARGATE_ROUTER,
  STARGATE_ROUTER_ETH: polygon.STARGATE_ROUTER_ETH,
  STARGATE_FACTORY: polygon.STARGATE_FACTORY,
  STARGATE_WIDGET_SWAP: polygon.STARGATE_WIDGET_SWAP,
  STARGATE_POOL_USDC: '0x1205f31718499dBf1fCa446663B532Ef87481fe1',
  STARGATE_DESTINATION_CHAIN_ID: 101, // Avalanche
  STARGATE_STABLE_TO_DISALLOW_TOKEN_ID: 16, // MAI

  LAYERZERO_ENDPOINT: '0x3c2269811836af69497E5F486A85D7316753cf62',

  COMPOUND_V3_COMET_USDC: '0xF25212E676D1F7F89Cd72fFEe66158f541246445',
