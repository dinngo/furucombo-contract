...
import "./libraries/SpookySwapLibrary.sol";

contract HSpookySwap is HandlerBase {
    using SafeERC20 for IERC20;

    // prettier-ignore
    address public constant UNISWAPV2_ROUTER = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
        ...
        )
    {
        ...
        address pair =
            SpookySwapLibrary.pairFor(router.factory(), token, router.WETH());
        _updateToken(pair);
    }
        ...
        )
    {
        ...
        // Update involved token
        address pair =
            SpookySwapLibrary.pairFor(router.factory(), tokenA, tokenB);
        _updateToken(pair);
    }
